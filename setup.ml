...
(* OASIS_START *)
(* DO NOT EDIT (digest: 9258e5f48190ce50763a16683a480cdb) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          synopsis =
            "Unboxed arrays with monomorphic and polymorphic elements";
          description = None;
          categories = [];
     ...
     oasis_version = "0.4.1";
     oasis_digest = Some "bJ\155\130\"|a\026\141\219B\166M| [";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
